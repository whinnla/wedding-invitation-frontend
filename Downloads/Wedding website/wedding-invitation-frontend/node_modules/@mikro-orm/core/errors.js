...
class ValidationError extends Error {
    ...
    static cannotUseGroupOperatorsInsideScalars(className, propName, payload) {
        return new ValidationError(`Using group operators ($and/$or) inside scalar properties is not allowed, move the operator above. (property: ${className}.${propName}, payload: ${(0, node_util_1.inspect)(payload)})`);
    }
